        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
              <h3 class="m-0 font-weight-bold text-primary">Data Type Violation</h3>
              @if(Auth::user()->roles == "admin")
                <div>
                    ...
                    <a href="{{ route('type_violation.create')}}" class="btn btn-primary">
                        <span class="icon text-white">
                        <i class="fas fa-plus"></i>
                        </span>
                        &nbsp;
                        <span class="text-*-center">Add Type Violation</span>
                    </a>
                </div>
                @endif
            </div>
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody class="align-self-left">
                    ...
                    <tr>
                      ...
                      @if(Auth::user()->roles == "admin")
                      <td align="center">
                            <a href="{{ route('type_violation.edit',$items->id)}}" class="btn btn-info">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                                <form action="{{ route('type_violation.destroy',$items->id)}}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('delete')
